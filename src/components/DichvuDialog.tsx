...
const DichvuDialog: React.FC<DichvuDialogProps> = ({
  isOpen,
  dichvuItem,
  onClose,
}) => {
          ...
          <Dialog.Panel as="div">
            ...
            >
              ...
              <p className="dichvu-dialog-date">
                {t("ngay")}:{" "}
                {new Date(dichvuItem.postdate).toLocaleDateString("vi-VN")}
              </p>
              ...
              {/* <div
                ...
                dangerouslySetInnerHTML={{
                  __html:
                    t(`content_dichvu_${dichvuItem.id}`) || dichvuItem.content,
                }}
              /> */}
